...
daysago = raw_input("Data from how many days ago:")
...
metadata_frame["Cases"]= cases_data_frame.iloc[:,[columns-1-daysago]]
metadata_frame["Deaths"]= deaths_data_frame.iloc[:,[columns-1-daysago]]
