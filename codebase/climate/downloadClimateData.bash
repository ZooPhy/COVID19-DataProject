...
join -t , -1 1 -2 1 sortedClimateDownload.csv StationMetadata.csv > climateData.csv #Merge based on station IDget ftp://ftp.ncdc.noaa.gov/pub/data/ghcn/daily/by_year/2020.csv.gz
